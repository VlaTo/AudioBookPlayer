...
namespace LibraProgramming.Memory
{
    public static class MemoryStream
    {
        ...
        internal static long ThrowArgumentExceptionForSeekOrigin()
        {
            throw new ArgumentException("The input seek mode is not valid.", "origin");
        }

        internal static Exception GetNotSupportedException()
        {
            return new NotSupportedException("The requested operation is not supported for this stream.");
        }

        internal static void ThrowArgumentExceptionForEndOfStreamOnWrite()
        {
        ...
        internal static Stream ThrowNotSupportedExceptionForInvalidMemory()
        {
            throw new ArgumentException("The input instance doesn't have a valid underlying data store.");
        }

        internal static void ThrowArgumentOutOfRangeExceptionForPosition()
        {
        ...
        internal static void ThrowArgumentOutOfRangeExceptionForOffset()
        {
            throw new ArgumentOutOfRangeException("offset", "Offset can't be negative.");
        }

        internal static void ThrowArgumentOutOfRangeExceptionForCount()
        {
            throw new ArgumentOutOfRangeException("count", "Count can't be negative.");
        }

        internal static void ThrowArgumentExceptionForLength()
        {
